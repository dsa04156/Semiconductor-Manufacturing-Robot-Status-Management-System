...
//               let newDataArr = [];
//               for (let j = 0; j < newData.length; j++){
//                 newDataArr.push([new Date(newData[j].date).toISOString(), newData[j].value]);
//               }
//               let updatedResultArr = [...resultArrData];
//               for(let i=0; i < updatedResultArr.length; i++){
//                 if(updatedResultArr[i].name === newData[0].name){
//                   updatedResultArr[i].data = [...updatedResultArr[i].data, ...newDataArr];
//                   break;
//                 }
//               }
//             });
